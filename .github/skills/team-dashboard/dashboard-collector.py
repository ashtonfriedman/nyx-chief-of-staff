...
# Configuration — ADO coordinates come from env vars (see SKILL.md); placeholders are fallbacks.
AZ_CLI = r"C:\Program Files\Microsoft SDKs\Azure\CLI2\wbin\az.cmd"
ORG_URL = os.environ.get("ADO_ORG", "https://dev.azure.com/{your-org}")
PROJECT = os.environ.get("ADO_PROJECT", "{your-project}")
AREA_PATH = os.environ.get("ADO_AREA", "{your-project}\\{your-area-path}")
...
SPRINTS = {
    "current": {
        ...
        "endDate": "2026-03-21",
        "iterationPath": "{your-project}\\{your-team}\\{FISCAL_QUARTER}\\Sprints\\Sprint-Current"
    },
    "previous": {
        "name": "Sprint-11",
        "startDate": "2026-02-22",
        "endDate": "2026-03-07",
        "iterationPath": "{your-project}\\{your-team}\\{FISCAL_QUARTER}\\Sprints\\Sprint-Previous"
    }
}
